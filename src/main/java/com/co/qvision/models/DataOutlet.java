...
public class DataOutlet {
    ...
    public DataOutlet(String identification, String password, String name, String lastname, String numidentify, String email, String telephone, String direction, String code) {
