...
public class Belts {
    ...
    public Belts(String identification, String password, String name, String lastname, String numidentify, String email, String telephone, String direction, String code) {
